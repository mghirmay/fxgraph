...
public class TableViewPropertyEditor extends Application {
    ...
    @Override public void start(Stage stage) {
        final Person aPerson = new Person("Fred", true, 12);
    ...
    public class Person {
        ...
        private Person(String firstName, Boolean isMarried, int age) {
    ...
    class EditingCell extends TableCell<NamedProperty, Object> {
        ...
        private void createCheckBox() {
            ...
            checkBox.setSelected(getBoolean());
            checkBox.setStyle("-fx-text-fill: green; -fx-font-size: 16px;");
